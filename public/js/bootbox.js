...
window.bootbox = window.bootbox || ( function init($, undefined) {"use strict";
		...
		function mergeButtons(labels, args, properties) {
			return validateButtons(mergeArguments(createButtons.apply(null, labels), args, properties), labels);
		}
