...
( function(factory) {'use strict';
					...
					$({
						...
						step : function(now) {
							if (_.options.vertical === false) {
								...
								animProps[_.animType] = 'translate(0px,' + now + 'px,0px)';
								_.$slideTrack.css(animProps);
							}
						},
						complete : function() {
		...
		Slick.prototype.changeSlide = function(event) {
			...
			switch (event.data.message) {
				...
				case 'next':
					_.slideHandler(_.currentSlide + _.options.slidesToScroll);
					var s = _.currentSlide + _.options.slidesToScroll;
					break;
		...
		Slick.prototype.setDimensions = function() {
			...
			if (_.options.vertical === false) {
				_.$slideTrack.width(Math.ceil((_.slideWidth * _.$slider.find('.slick-slide').length)));
				if (_.options.centerMode === true) {
					_.$list.css({
				...
				_.$slideTrack.height(Math.ceil((_.listHeight * _.$slider.find('.slick-slide').length)));
				if (_.options.centerMode === true) {
					_.$list.css({
